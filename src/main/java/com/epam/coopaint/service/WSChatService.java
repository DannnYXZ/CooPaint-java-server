...
public class WSChatService {
    ...
    private final Map<UUID, List<Message>> chatBoxes = new HashMap<>(); // <chat, messages> ~ persistent
    ...
    public Pair<List<Message>, Set<Session>> addMessages(UUID chatUUID, List<Message> messages) {
